...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_root', dest='data_root',
                        default='/home/yixu/DHNdata/batchsize16_allRealCleanData20181226/alldata/test/',
                        help='dataset root path')

    parser.add_argument('--is_cuda', dest='is_cuda', default=True, type=bool, help='use GPU?')

    parser.add_argument('--model_path', dest='model_path',
                        default="/home/yixu/PycharmProjects/deepmot/deepmot/nowbestmodel/ourbestDeepMunkres/"
                                "model_best_model3doubleV3bigdatafinetune.pth",
    ...
    # constraints
    parser.add_argument('--row_wise', dest='row_wise', default=False, type=bool, help='row wise soft-max? column wise '
                                                                                     'if False')
